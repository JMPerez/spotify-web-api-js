  ...
  describe('Basic tests', function() {
    ...
    describe('Using callbacks', function() {
      ...
      it('should get multiple tracks', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/tracks/?ids=0eGsygTp906u18L0Oimnem%2C1lDWb6b6ieDQ2xT7ewTC3G');
      });
      ...
      it('should get multiple albums', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/albums/?ids=41MnTivkwTO3UUJ8DrqEJJ%2C6JWc4iAiJ9FjyK0B59ABb4');
      });
      ...
      it('should get an artist\'s top tracks', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/artists/5YyScSZOuBHpoFhGvHFedc/top-tracks?country=ES');
      });
      ...
      it('should get multiple artists', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/artists/?ids=0oSGxfWSnnOXhD2fKuz2Gy%2C3dBVyJ7JuOMt4GE9607Qin');
      });
      ...
      it('should check if a track is in the user\'s saved tracks', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/me/tracks/contains?ids=1ryJP6qCpF1mBv0vXS8fyq%2C5pRgDDjJcxaYwpsRJBoVXr');
      });
      ...
      it('should check if a album is in the user\'s saved albums', function() {
        ...
        expect(callback.calledWith(null, [true, true])).toBeTruthy();
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/me/albums/contains?ids=1WDA6r4advRJalp0gJCoXv%2C088HGHE7BhAMAy9fAApAGP');
      });
      ...
      it('should get a playlist', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/users/jmperezperez/playlists/7Kud0O2IdWLbEGgvBkW9di');
      });
      ...
      it('should get the tracks of a playlist', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/users/wizzler/playlists/0EIVqzEcrY2a8vO0AUJar2/tracks');
      });
      ...
      it('should get featured playlists', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/browse/featured-playlists?locale=sv_SE&country=SE&timestamp=2014-10-23T09%3A00%3A00');
      });
      ...
      it('should check whether a user is following several other users', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/me/following/contains?ids=userid01%2Cuserid02&type=user');
      });
      ...
      it('should follow artists', function() {
        ...
        expect(callback.calledWith(null, '')).toBeTruthy();
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/me/following/?ids=artistid01%2Cartistid02&type=artist');
      });
      ...
      it('should follow a playlist publicly', function() {
        ...
        expect(callback.calledWith(null, '')).toBeTruthy();
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/users/spotify/playlists/2ujjMpFriZ2nayLmrD1Jgl/followers');
      });
      ...
      it('should check whether users are following a playlist', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/users/spotify/playlists/2ujjMpFriZ2nayLmrD1Jgl/followers/contains?ids=userid01%2Cuserid02');
      });
      ...
      it('should get recommendations', function() {
        ...
        expect(that.requests.length).toBe(1);
        expect(that.requests[0].url).toBe('https://api.spotify.com/v1/recommendations?min_energy=0.4&market=ES&seed_artists=6mfK6Q2tzLMEchAr0e9Uzu%2C4DYFVNKZ1uixa6SQTvzQwJ&limit=5&min_popularity=50');
      });
